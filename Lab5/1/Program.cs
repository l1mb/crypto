...
namespace Lab5
{
    ...
    class multiple_permutation
    {
        ...
        static void Main(string[] args)
        {
            ...
            string firstKey = "siarhe";
            // Второй ключ, количество строк
            string secondKey = "sia";
            ...
            ShowKey(listCharNumFirst, "First key: ");
            ShowKey(listCharNumSecond, "Second key: ");
            ...
            ShowMatrix(matrix, "Init value: ");
            long sec2 = (DateTime.Now.Ticks - sec) / 1000;
            Console.WriteLine("time of matrix creation: " + sec2 + "\n");
            ...
            ShowMatrix(matrix, "Encrypted value: ");
            long sc2 = (DateTime.Now.Ticks - sc) / 1000;
            Console.WriteLine("time of execution:" + sc2 + "\n");
